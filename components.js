 ...
 *
 * Opzionale: per usare i simboli di CircuiTikZ-Designer, scarica data/symbols-designer.svg
 * (vedi data/README.md) e aggiungi a ogni item il campo symbolId con l'id del <symbol>
 * presente in quel file (es. symbolId: "resistor" se nel file c'è <symbol id="resistor">).
 * Se symbolId è impostato e il file è caricato, viene usato quel simbolo al posto di svg.
 */
    ...
    resistors: {
        ...
        items: {
            ...
            varResistor: {
                ...
                width: 80, height: 40,
                symbolId: "path_variable-american-resistor"
            },
            potentiometer: {
                name: "Potentiometer",
                tikzName: "pR",
                ...
                width: 80, height: 40,
                symbolId: "path_american-potentiometer"
            }
        }
    },
    ...
    dynamics: {
        ...
        items: {
            ...
            varCapacitor: {
                ...
                width: 60, height: 35,
                symbolId: "path_variable-capacitor"
            },
            curvedCap: {
                name: "Curved Cap",
                tikzName: "cC",
                ...
                width: 60, height: 30,
                symbolId: "path_curved-capacitor"
            },
            capSensor: {
                name: "Cap Sensor",
                tikzName: "sC",
                ...
                width: 60, height: 40,
                symbolId: "path_capacitive-sensor"
            },
            piezoelectric: {
                name: "Piezoelectric",
                tikzName: "PZ",
    ...
    sources: {
        ...
        items: {
            vsource: {
                ...
                width: 60, height: 40,
                symbolId: "path_american-voltage-source"
            },
            isource: {
                name: "DC Current",
                tikzName: "isource",
                ...
                width: 60, height: 40,
                symbolId: "path_american-current-source"
            },
            battery: {
                name: "Battery",
                tikzName: "battery1",
    ...
    transistors: {
        ...
        items: {
            ...
            npn: {
                ...
                tikzName: "npn",
                category: "bjt",
                availableOptions: ['solderdot'], // bulk non esiste per BJT in Circuitikz
